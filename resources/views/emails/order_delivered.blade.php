...
<head>
    ...
    <title>Thanks! We are processing your order From Ekota Trade</title>
</head>
<body class="bg-white">
...
<div style="background:#fff; width:90%;margin:0 auto !important">
    ...
    <tbody>
        <tr style="text-align:center">
            <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
               <img src="https://www.ekotatrade.com.bd/public/uploads/settings/1721135785-untitled-design.webp" style="width:180px;margin-top:15px">
             </td>
        </tr>
    </tbody>
</table>
            ...
            <tr>
                <td>
                    <ul style="padding:0 !important">                       
        				<li style="list-style: none; margin: 0 5px; height: 40px; width: 40px; text-align: center; line-height: 40px; background: #4551F7; border-radius: 50px;float:left !important"><a href="https://www.facebook.com/websolutionitcom"><img src="https://www.ekotatrade.com.bd/public/uploads/settings/1721135785-untitled-design.webp"  style="margin-top: 8px;height: 25px;" /></a></li>
        				                    
        				<li style="list-style: none; margin: 0 5px; height: 40px; width: 40px; text-align: center; line-height: 40px; background: #4DBC60; border-radius: 50px;float:left !important"><a href="https://wa.link/zw696d"><img src="https://www.ekotatrade.com.bd/public/uploads/settings/1721135785-untitled-design.webp" style="margin-top: 8px;height: 25px;" /></a></li>
        			</ul>
    			</td>
			</tr>
        </tbody>
        ...
        <tbody style="background:#4DBC60;">
            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box;  margin: 0;border:0">
                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; margin: 0;">
                   <p style="color:#fff;text-align:center;padding:20px 0;font-size:15px;letter-spacing:2px">@copyright {{date('Y')}} Ekotatrade</p>
                 </td>
            </tr>
        </tbody>
    </table>
