            ...
            <div class="row justify-content-center">
                <div class="col-sm-8">
                    ...
                    <div class="success-title">
                        <h2>আপনার অর্ডারটি আমাদের কাছে সফলভাবে পৌঁছেছে, কিছুক্ষনের মধ্যে আমাদের একজন প্রতিনিধি আপনার
                            নাম্বারে কল করবেন </h2>
                    </div>
                            ...
                            <tbody>
                                @foreach ($order->orderdetails as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <p><strong>Tk {{ $value->sale_price }}</strong></p>
                                        </td>
                                    </tr>
                                @endforeach
                                <tr>
                                    ...
                                    <td><strong
                                            id="net_total">Tk{{ $order->amount - ($order->shipping_charge + $order->discount) }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-end px-4">Shipping Cost</th>
                                    <td>
                                        <strong id="cart_shipping_cost">Tk{{ $order->shipping_charge }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-end px-4">Discount</th>
                                    <td>
                                        <strong id="cart_shipping_cost">Tk{{ $order->discount }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-end px-4">Grand Total</th>
                                    <td>
                                        <strong id="grand_total">Tk{{ $order->amount }}</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
