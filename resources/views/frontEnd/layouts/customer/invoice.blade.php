                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td  style="width:60%;float: left;">
                                ...
                                <div class="invoice-bar" style="background:#fff;  width: 80%; margin-left: 135px; padding: 12px 32px; margin-top: 6px;text-align:right">
                                   <p style="display:inline-block">Invoice Date: <strong>{{$order->created_at->format('d-m-y')}}</strong></p><br>
                                   <p style="display:inline-block">Invoice No: <strong>{{$order->invoice_id}}</p>
                                    </p>
                                </div>
                    ...
                    <table class="table" style="margin-top: 30px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$value->product_name}}  <br> @if($value->product_size) <small>Size/Model: {{$value->product_size}}</small> @endif   @if($value->product_color) <small>Color: {{$value->product_color}}</small> @endif</td>
                        ...
                        <table class="table" style="margin-bottom: 0px;">
                            ...
                            ?></td>
                                ...
                                <tr >
                                    ...
                                    <td><strong>Tk{{$order->discount}}</strong></td>
                                </tr>
