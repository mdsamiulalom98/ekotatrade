                    ...
                    <div class="breadcrumb">
                        <ul>
                            ...
                            @if ($details->subcategory)
                                <li><span>/</span></li>
                                <li><a href="{{ route('subcategory', $details->subcategory->slug) }}">{{ $details->subcategory ? $details->subcategory->subcategoryName : '' }}</a>
                                </li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6 position-relative">
                                    @if (
                                        ($details->old_price !== null || ($details->product_type == 2 && isset($details->variable->old_price))) &&
                                        ...
                                        <div class="product">
                                            <div class="product-cart">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        @foreach ($details->variables as $index => $variable)
                                                            ...
                                                            <p class="details-price">
                                                                <span class="taka-sign before">{{ $variable->new_price }}</span>
                                                            </p>
                                                        @endforeach
                                                    </div>
                                                @else
                                                                    ...
                                                                    <div class="selector">
                                                                        @foreach ($sliderimages as $key => $procolor)
                                                                            <div class="selector-item color-item"
                                                                                data-id="{{ $key }}" @if (!isset($procolor['color'])) style="display:none"
                                                                                @endif>
                                                                    ...
                                                                    <div class="selector">
                                                                        @foreach ($sliderimages as $key => $prosize)
                                                                            <div class="selector-item size-item"
                                                                                data-id="{{ $key }}" @if (!isset($prosize['size']))
                                                ...
                                                <div class="d-flex single_product col-sm-12 mt-2">
                                                    <button data-id="{{ $details->id }}" class="hover-zoom wishlist_store"
                                                        title="Wishlist"><i class="fa-regular fa-heart"></i> Add To
                                                        Wishlist</button>
                                                </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="staticBackdropLabel">
                                            {{ Auth::guard('customer')->user() ? 'Your question' : 'You must Login First' }}
                                        </h1>
                                            ...
                                            @if (Auth::guard('customer')->user())
                                                <form action="{{ route('customer.question') }}" id="review-form" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea required class="form-control radius-lg" name="comment"
                                                ...
                                                <form action="{{ route('customer.signin') }}" method="POST"
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" id="phone"
                                                            style="border: 1px solid;border-color: #2377c3;"
                                                                    ...
                                                                    @foreach ($review->images as $image)
                                                                        <div class="review-image-item">
                                                                            <img src="{{ asset($image->image) }}"
                                                                                alt="{{ $image->alt_text }}" class="gallery-image"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                                                        {{ Auth::guard('customer')->user() ? 'Your review' : 'You must Login First' }}
                                                    </h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                            ...
                                            <td class="img">
                                                <a href="{{ route('product', $value->slug) }}">
                                                    <img width="50" height="50"
                                                        src="{{ asset($value->image ? $value->image->image : '') }}" alt="" />
                                                </a>
                                            </td>
                                            <td class="title">
                                            ...
                                            <div class="product_item wist_item">
                                                <div class="product_item_inner">
                                                    <div class="pro_img">
                                                        ...
                                                        @else
                                                            <div class="quick_view_btn">
                                                                <button data-id="{{ $value->id }}" class="hover-zoom quick_view" title="Wishlist"><i
                                                            ...
                                                            @if ($value->variable_count > 0 && $value->type == 0)
                                                                <p>
                                                                    @if ($value->variable->old_price)
                                                                        <del class="taka-sign before">{{ $value->variable->old_price }}</del>
                                                                    @endif
                                                                    <span class="taka-sign before">{{ $value->variable->new_price }}</span>
                                                                </p>
                                                            @else
                                                                <p>
                                                                    @if ($value->old_price)
