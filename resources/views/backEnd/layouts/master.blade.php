            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-product">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.order.product_print') }}"><i
                                                data-feather="file-plus"></i> Product Slip</a>
                                    </li>
                        ...
                        <!-- nav items end -->
                        @php
                            $pending_reviews = \App\Models\Question::where('status', 'pending')->count();
                        @endphp
                        <li>
                            ...
                            <div class="collapse" id="sidebar-product-question">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('question.pending') }}"><i data-feather="file-plus"></i>
                                            Pending Question ({{ $pending_reviews }})</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('question.index') }}"><i data-feather="file-plus"></i> All
                                            Questions</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-coupon">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('couponcodes.create') }}"><i data-feather="file-plus"></i>
                                            Create</a>
                                    </li>
                                    <li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-sitesetting">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('newsticker.index') }}"><i data-feather="file-plus"></i>
                                            News Ticker</a>
                                    </li>
                                    <li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 text-end">&copy; {{ $generalsetting->name }} <a
                                href="https://websolutionit.com" style="display: none;" target="_blank">Websolution
                                IT</a></div>
                    </div>
                </div>
            </footer>
