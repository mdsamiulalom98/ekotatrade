                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list custom-btn-list">
                                    <a href="{{ route('product', $value->slug) }}" target="_blank" title="view"><i class="fe-eye"></i></a>
                                    @if($value->status == 1)
                            ...
                            <td>
                                ...
                                <img src="{{asset($value->image->image??'')}}" class="backend-image" alt="">
                                @else
                                <img src="{{asset($value->variable->image??'')}}" class="backend-image" alt="">
                                @endif
                            </td>
                            <!-- new price -->
                            @if($value->product_type == 1)
