        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Payment Method Create</h4>
                </div>
            </div>
        </div>
        <!-- end Payment Methodtitle -->
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('paymentmethods.store') }}" method="POST" class=row data-parsley-validate=""
