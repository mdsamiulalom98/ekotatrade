 ...
 @foreach ($cartinfo as $key => $value)
     <tr>
         ...
         <td>
             <div class="qty-cart vcart-qty">
                 <div class="quantity">
                     ...
                     <input type="text" value="{{ $value->qty }}" class="quantity_update"
                         data-id="{{ $value->rowId }}" />
         ...
         <td class="discount"><input type="number" class="product_price" value="{{ $value->price }}"
                 placeholder="0.00" data-id="{{ $value->rowId }}" /></td>
