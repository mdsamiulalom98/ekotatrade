                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->name}}</td>
                            <td><img src="{{asset($value->white_logo)}}" style="height: 60px; width: auto;" alt=""></td>
                            <td><img src="{{asset($value->dark_logo)}}" style="height: 60px; width: auto; background-color: black;" alt=""></td>
                            <td><img src="{{asset($value->favicon)}}" style="height: 60px; width: auto;" alt=""></td>
