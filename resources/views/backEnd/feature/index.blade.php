        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('features.create')}}" class="btn btn-primary rounded-pill">Create</a>
                </div>
                <h4 class="page-title">Feature Manage</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->title}}</td>
                            <td>{{$value->link}}</td>
                            <td><img style="background-color: blue; padding: 5px;" src="{{asset($value->image)}}" class="backend-image" alt=""></td>
                            <td>
                                @if($value->status==1)
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <a href="{{route('features.edit',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
