        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('contact.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label for="hotmail" class="form-label">Contact Mail (for orders)</label>
                            <input type="email" required class="form-control @error('hotmail') is-invalid @enderror" name="hotmail" value="{{ $edit_data->hotmail}}" id="hotmail">
                            @error('hotmail')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label for="messanger" class="form-label">Messanger Link</label>
                            <input type="text" class="form-control @error('messanger') is-invalid @enderror" name="messanger" value="{{ $edit_data->messanger }}"  id="messanger" >
                            @error('messanger')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
