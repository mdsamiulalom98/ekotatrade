                ...
                <form action="{{route('contact.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="email" class="form-control @error('hotmail') is-invalid @enderror" required name="hotmail" value="{{ old('hotmail') }}" id="hotmail">
                            @error('hotmail')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('messanger') is-invalid @enderror" name="messanger" value="{{ old('messanger') }}"  id="messanger" >
                            @error('messanger')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
