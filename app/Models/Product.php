...
class Product extends Model
{
    ...
    {
        return $this->hasMany(Review::class, 'product_id')->select('id', 'ratting', 'product_id')->where('status', 'active');
    }
    ...
    {
        return $this->hasOne(ProductVariable::class, 'product_id');
    }
    public function variables()
    {
        return $this->hasMany(ProductVariable::class, 'product_id')->whereNotNull('image');
    }
}
