...
Route::group(['namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::get('/shop', [FrontendController::class, 'all_products'])->name('all.product');
    ...
    Route::get('/shipping-landing', [FrontendController::class, 'shipping_charge_landing'])->name('shipping.landing');
    ...
    //pro checker
    Route::get('product-checker', [FrontendController::class, 'product_check'])->name('product.checker');
    Route::get('warranty-checker', [FrontendController::class, 'warranty_check'])->name('warranty.checker');

    Route::post('/customer/send-otp', [FrontendController::class, 'send_otp'])->name('customer.send_otp');
    Route::get('/customer/remove-otp', [FrontendController::class, 'remove_otp'])->name('customer.remove_otp');
    Route::get('/customer/validate-otp', [FrontendController::class, 'validate_otp'])->name('customer.validate_otp');
    Route::get('/customer/check-coupon', [FrontendController::class, 'check_coupon'])->name('check.coupon');
    // cart route
...
Route::group(['prefix' => 'customer', 'namespace' => 'Frontend', 'middleware' => ['customer', 'ipcheck', 'check_refer']], function () {
    ...
    Route::get('/courier-invoice', [CustomerController::class, 'courier_invoice'])->name('customer.courierinvoice');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    // categories
    Route::get('features/manage', [FeatureController::class, 'index'])->name('features.index');
    Route::get('features/{id}/show', [FeatureController::class, 'show'])->name('features.show');
    Route::get('features/create', [FeatureController::class, 'create'])->name('features.create');
    Route::post('features/save', [FeatureController::class, 'store'])->name('features.store');
    ...
    Route::post('features/inactive', [FeatureController::class, 'inactive'])->name('features.inactive');
    Route::post('features/active', [FeatureController::class, 'active'])->name('features.active');
    Route::post('features/destroy', [FeatureController::class, 'destroy'])->name('features.destroy');
    ...
    // Route::get('/qr', [ProductController::class,'qr'])->name('products.qr');
    ...
    Route::post('campaign/replicate', [CampaignController::class, 'replicate'])->name('campaign.replicate');
    ...
    Route::get('order/quantity-update', [OrderController::class, 'quantity_update'])->name('admin.order.quantity_update');
    ...
    Route::get('question/pending', [QuestionController::class, 'pending'])->name('question.pending');
    Route::post('question/inactive', [QuestionController::class, 'inactive'])->name('question.inactive');
    Route::post('question/active', [QuestionController::class, 'active'])->name('question.active');
    Route::get('question/create', [QuestionController::class, 'create'])->name('question.create');
    Route::post('question/save', [QuestionController::class, 'store'])->name('question.store');
